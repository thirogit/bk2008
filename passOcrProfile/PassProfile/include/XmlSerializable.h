...
class AFX_EXT_CLASS CXmlSerializable
{
public:
...
protected:
	...
	void AppendMemberNode(const cmString& nodeName, const COleDateTime& nodeValue, CComPtr<IXMLDOMElement>& parentElement,CComPtr<IXMLDOMDocument2>& xmlDoc);
	...
	void AppendAttributeNode(const cmString& nodeName, const COleDateTime& nodeValue, CComPtr<IXMLDOMElement>& parentElement, CComPtr<IXMLDOMDocument2>& xmlDoc);
	...
	bool ExtractMemberNode(CComPtr<IXMLDOMNode>& parentElement, const cmString& nodeName, COleDateTime& member);
	...
	bool ExtractAttributeNode(CComPtr<IXMLDOMNode>& parentElement, const cmString& nodeName, COleDateTime& member);
	...
	bool ExtractTextNode(CComPtr<IXMLDOMNode>& parentElement, COleDateTime& member);
	...
	void AppendTextNode(COleDateTime& value, CComPtr<IXMLDOMNode>& parentElement, CComPtr<IXMLDOMDocument2>& xmlDoc);

	cmString FormatDateTime(const COleDateTime& dt);
	COleDateTime ScanDateTime(const cmString& str);
