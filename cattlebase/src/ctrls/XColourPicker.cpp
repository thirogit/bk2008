...
{
	TRACE("in CXColourPicker::CXColourPicker\n");
...
{
	TRACE("in CXColourPicker::OnSelEndOK\n");
...
{
	TRACE("in CXColourPicker::OnSelEndCancel\n");
...
{
	TRACE("in CXColourPicker::OnSelChange: %06X\n", wParam);
...
{
	TRACE("in CXColourPicker::OnCreate\n");
...
{
	TRACE("in CXColourPicker::OnClicked\n");
	CRect rect;
	GetWindowRect(rect);
	TRACE("   this=0x%0X\n", this);
...
{
	TRACE(_T("in CXColourPicker::SetColor: %06X\n"), crColor);
...
{
	TRACE("in CXColourPicker::OnEnable\n");
