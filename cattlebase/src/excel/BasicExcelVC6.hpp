...
public:
	...
	CellTypeEnum Type() const;		///< Get type of value stored in current Excel cell. Returns one of the above enums. 
...
private:
	CellTypeEnum type_;				///< Type of value stored in current Excel cell. Contains one of the above enums.
