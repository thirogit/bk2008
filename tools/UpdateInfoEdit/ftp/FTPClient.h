...
namespace nsFTP
{
   ...
   public:
	  ...
	  bool Download(const tstring& strRemoteFile, ITransferNotification* pOutput, bool fPasv) const;
	  ...
	  bool Upload(ITransferNotification* pInput, const tstring& strRemoteFile, bool fPasv) const;
