...
public:
	...
	static void DrawString(CDC* pDC, const string& str, CRect& rc, UINT format, string fontName = "tahoma", int fontSize = -12, COLORREF textColor = 0, bool fontBold = false);
	static void DrawString(CDC* pDC, const string& str, CRect& rc, UINT format, COLORREF textColor, CFont* font);
