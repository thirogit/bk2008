...
void cmBinaryWildCardsCell::Draw(CDC* pDC)
{
	...
	for (unsigned int i = 0; i < bitRect_.size(); i++) {
...
bool cmBinaryWildCardsCell::ProcessMessage(DWORD msg, DWORD lParam, DWORD wParam, const CPoint& pt, const CRect& parentRect, bool& needRedraw)
{
