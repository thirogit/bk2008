// cmCheckBoxFrRenderer.cpp: implementation of the cmCheckBoxFrRenderer class.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"
#include "cmCheckBoxFrRenderer.h"
...
cmCheckBoxFrRenderer::cmCheckBoxFrRenderer()
{
...
void cmCheckBoxFrRenderer::Draw(CDC* pDC, cmBaseCell* cell)
{
	CRect txtRect;
	CFont* font;
	cmCheckBoxCell* c;
